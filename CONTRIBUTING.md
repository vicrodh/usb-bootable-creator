...
Thank you for your interest in improving MajUSB. Please read these guidelines before opening a PR or issue.
...
- No build, no pull requests: always run `cargo build` (or stricter) before committing. Do not commit failing code. Include build output in PRs.
...
- Use of AI is allowed, but always double check any AI generated code; never push un-audited code. Co-authors and AI footers are not allowed.
...
4. **Commit Messages**  
   Use clear, descriptive titles (e.g., `fix(gui): show missing packages window`). No co-authors, keep own responsibility.
